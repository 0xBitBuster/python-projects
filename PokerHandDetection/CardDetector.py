...
from utils import find_poker_hand, draw_text_with_background
...
class CardDetector:
    ...
    def draw_detections_and_hand(self, frame, predictions_parsed):
        detected_cards = []
        ...
        hand = find_poker_hand(detected_cards)
        draw_text_with_background(frame, hand, (0, 25))
    ...
    def process_video(self):
        while self.cap.isOpened():
            ...
            self.draw_detections_and_hand(frame, predictions_parsed)
